...
//////////////////일단 은 클라이언트에서 다운로드만 되게...///////////////////
  if ((dir = opendir("/home/mobis/Public/")) != nullptr) {
        while ((diread = readdir(dir)) != nullptr) {
            ...
            if(strcmp(diread->d_name,".") != 0)
            {
              if(strcmp(diread->d_name,"..") != 0){
                ...
                f_manager.add_file(new myfile(diread->d_name,++file_no , "1234", 900));
              }
            }
        }
        closedir (dir);
  ...
  ////////////////////////////////////////////////////////////////////////////////////////
    ...
    case 1: //파일 다운로드
        ...
        //cout << "선택한 파일 이름 : " << f_manager.get_file_title(select) << endl;
        memset(buf,0,sizeof(buf));
    ...
    fread(write_buf, sizeof(char), sizeof(write_buf), fp); //file stream 에 있는 걸 write_buf로 읽어 옵니다.
